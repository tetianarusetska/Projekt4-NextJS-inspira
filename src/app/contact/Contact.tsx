...
export default function Contact() {
    ...
    return (
        <main className="flex-1 w-full relative z-10">
            ...
            <section className="grid grid-cols-12 w-full border-b border-black min-h-[calc(100vh-72px)] items-stretch">
                
                {/* ================= LEFT COLUMN ================= */}
                <div className="col-span-5 p-12 border-r border-black flex flex-col justify-between min-h-[400px]">
                    <div>
                    ...
                    <div className="my-auto pt-8">
                        <h1 className="text-5xl lg:text-[64px] leading-[102%] tracking-[1%] font-display uppercase mb-6">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-sm text-black font-text font-medium">
                            <a href="mailto:rusetskatata@gmail.com" className="underline hover:text-neutral-600 transition-colors">
                ...
                <div className="col-span-7 p-12 flex items-center justify-center bg-white/30">
                    <div className="w-full max-w-[500px] bg-[#EDEDED] border-2 border-black p-8 md:p-10 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative">
                        ...
                        {sent ? (
                            <div className="p-6 bg-black text-[#EDEDED] border border-black flex flex-col items-center justify-center space-y-4 text-center">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="space-y-1">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-transparent border-b border-black/20 focus:border-black py-2.5 text-sm font-medium text-black outline-none transition-all duration-200 font-text placeholder:text-neutral-400 resize-none"
                                    />
                                </div>
                                ...
                                <button
                                    type="submit"
                                    className="w-full py-4 bg-black text-[#EDEDED] text-xs font-black tracking-widest uppercase hover:bg-neutral-800 hover:scale-[1.01] active:scale-[0.99] transition-all border border-black cursor-pointer font-text"
                                >
                                    Absenden
                                </button>
                            </form>
