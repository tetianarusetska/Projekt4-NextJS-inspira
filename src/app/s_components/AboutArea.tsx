export default function AboutArea() {
    ...
    return (
        <>
            <div className="mt-100 relative z-30 w-screen h-screen">
                ...
                <div className="flex flex-col">
                    ...
                    <p className="absolute left-15.25 top-73 text-[36px] text-left leading-[100%] tracking-[1%] mr-12">
                    ...
                    <p className="text-left grotesk-xbold absolute left-15.25 top-133 text-[40px] leading-[34%] tracking-[1%] uppercase">Analog gesammelt. Digital bewahrt. Personlich verbunden.</p>
                </div>

                <div className="left-0 top-163 absolute w-full border-t-2 border-[#808080] border-b-2">
                    <div className="px-6 py-8 ml-10 flex flex-col gap-4">
                        <p
                            className="grotesk-xbold text-[36px] leading-[100%] tracking-[5%] uppercase"
                        >
                            N°01, PERSONLICH.
                        </p>
                ...
                <div className="left-0 top-203 absolute w-full border-[#808080] border-b-2">
                    <div className="ml-10 px-6 py-8 flex flex-col gap-4">
                        ...
                        <p className="text-[24px] text-left leading-[100%] tracking-[1%]">
                            Kein physisches Regal, keine Grenzen. Deine Sammlung wächst mit dir,
                            überall zugänglich, immer geordnet.
                        </p>
                    </div>
                </div>

                <div className="left-0 top-243 absolute w-full border-[#808080] border-b-2">
                    <div className="ml-10 px-6 py-8 flex flex-col gap-4">
                        <p
                            className="grotesk-xbold text-[36px] leading-[100%] tracking-[5%] uppercase"
                        >
                ...
                <div className="absolute left-0 top-303 mx-10">
                    ...
                    <div className="mt-10 w-full h-60 border-dashed border-[#808080] border-2">
                        ...
                        <div className="grid grid-cols-4">
                            ...
                            <div className="flex flex-col gap-4  border-r-2 h-60 border-[#808080]">
                ...
                <div className="absolute left-0 top-423 w-full flex flex-col justify-center items-center">
                    <p
                        className="text-center grotesk-xbold text-[64px] leading-[100%] uppercase tracking-[5%]"
                    >
